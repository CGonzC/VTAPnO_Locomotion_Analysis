...
%   '2ms_peak_anywhere'  -> Cerniauskas et al., 2019
%   '6ms_fixed'          -> De Jong et al., 2024 (orthodromic)
%
% Both modes:
...
spikeCsv = 'examples/optotag/Curated_clusters_1.csv';
stimMat  = 'examples/optotag/Stim_R1.mat';   % must load variable 'selectedPoints' (samples)

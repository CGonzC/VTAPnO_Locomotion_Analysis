...
% Switch between the two published criteria with 'criterion':
%   '2ms_peak_anywhere'  -> Cerniauskas 2019
%   '6ms_fixed'          -> De Jong/Lammel 2024 (orthodromic)
%
% Both modes:
...
%% ---------- CHOOSE NEURONS ----------
neuronInput = input('Enter neuron IDs (e.g. 0,3,27) or "all": ', 's');
